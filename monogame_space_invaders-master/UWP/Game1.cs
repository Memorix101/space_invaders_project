...
namespace UWP_SpaceInvaders
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            //Update Windowsize
            gameViewport.X = (int)ApplicationView.GetForCurrentView().VisibleBounds.Width / 2 - gameViewport.Width / 2;
            gameViewport.Y = (int)ApplicationView.GetForCurrentView().VisibleBounds.Height / 2 - gameViewport.Height / 2;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(arcade, new Rectangle((int)ApplicationView.GetForCurrentView().VisibleBounds.Width/2 - arcade.Width /2, ((int)ApplicationView.GetForCurrentView().VisibleBounds.Height / 2 - arcade.Height / 2) + 35, arcade.Width, arcade.Height), null, new Color(0.5f, 0.5f, 0.5f));
