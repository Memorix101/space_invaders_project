...
public class MyGdxGame extends ApplicationAdapter {
	...
	public void create() {
		...
		gameover_ui = new Texture("gameover_ui.png");
		win_ui = new Texture("win_ui.png");

		player.Create();

		spawnEnemies();

		music = Gdx.audio.newMusic(Gdx.files.internal("boden.mp3"));
		music.setLooping(true);

		score_font = new BitmapFont(Gdx.files.internal("vermin.fnt"),
				Gdx.files.internal("vermin.png"), false);

		/*snd_music = Gdx.audio.newSound(Gdx.files.internal("bodenstaendig.ogg"));
		long id = snd_music.play(1.0f);
		snd_music.setLooping(id, true);*/
	...
	public void render() {
		...
		if (game_start) {
			...
			String padded="0000".substring(Integer.toString(score).length()) + score;
			score_font.draw(batch, "SCORE: " + padded, 640 - 190, 480 - 10);
