...
void load_assets()
{
	space3_tex2d = IMG_Load("sd:/rd/space3.png");
	enemy_tex2d = IMG_Load("sd:/rd/invader32x32x4.png"); //invader32x32x4
	player_tex2d = IMG_Load("sd:/rd/player.png");
	bullet_tex2d = IMG_Load("sd:/rd/bullet.png");
	enemy_bullet_tex2d = IMG_Load("sd:/rd/enemy-bullet.png");
	explo_tex2d = IMG_Load("sd:/rd/explode.png");
	fmg_splash_tex2d = IMG_Load("sd:/rd/fmg_splash.png");
	gameover_tex2D = IMG_Load("sd:/rd/gameover_ui.png");
	win_tex2d = IMG_Load("sd:/rd/win_ui.png");
	//scoreFont = IMG_Load();
}
...
int main(int argc, char *argv[]) {
	...
	//ttf stuff
	TTF_Font* vermin_ttf = TTF_OpenFont("sd:/rd/vermin_vibes_1989.ttf", 24);
	SDL_Rect score_pos;
