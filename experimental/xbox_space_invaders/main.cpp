...
*/
	...
	//load audio
//	snd_blaster = Mix_LoadWAV("D:\\rd\\blaster.mp3");
//	snd_explo = Mix_LoadWAV("D:\\rd\\explode1.wav");
//	snd_pusher = Mix_LoadWAV("D:\\rd\\pusher.wav");
//	music = Mix_LoadMUS("D:\\rd\\bodenstaendig.mp3");
...
*/
	...
	//init font stuff
	vermin_ttf = TTF_OpenFont("D:\\rd\\vermin_vibes_1989.ttf", 24);
	char textBuffer[64];
