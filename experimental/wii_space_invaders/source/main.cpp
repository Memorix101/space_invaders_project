...
audiogc::player *music_player = NULL;
audiogc::player *snd_pusher = NULL;
audiogc::player *snd_explo = NULL;
audiogc::player *snd_blaster = NULL;
...
void load_assets()
{
	...
	music_player = new audiogc::player(audiogc::type::detect, "sd:/apps/space_invaders_game/rd/blaster.ogg");
	snd_pusher = new audiogc::player(audiogc::type::detect, "sd:/apps/space_invaders_game/rd/pusher.ogg");
	snd_explo = new audiogc::player(audiogc::type::detect, "sd:/apps/space_invaders_game/rd/explode1.ogg");
	snd_blaster = new audiogc::player(audiogc::type::detect, "sd:/apps/space_invaders_game/rd/bodenstaendig.ogg");
}
