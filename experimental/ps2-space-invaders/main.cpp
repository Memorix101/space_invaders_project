...
void load_assets()
{
	sprintf(filename, "cdrom0:\\RD\\SPACE3.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
	space3_tex2d = IMG_LoadPNG_RW(rwop);

	sprintf(filename, "cdrom0:\\RD\\INVADERS.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
	enemy_tex2d = IMG_LoadPNG_RW(rwop); //invader32x32x4
	
	sprintf(filename, "cdrom0:\\RD\\PLAYER.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
	player_tex2d = IMG_LoadPNG_RW(rwop);

	sprintf(filename, "cdrom0:\\RD\\BULLET.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
	bullet_tex2d = IMG_LoadPNG_RW(rwop);

	sprintf(filename, "cdrom0:\\RD\\EBULLET.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
	enemy_bullet_tex2d = IMG_LoadPNG_RW(rwop);

	sprintf(filename, "cdrom0:\\RD\\EXPLODE.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
	explo_tex2d = IMG_LoadPNG_RW(rwop);

	sprintf(filename, "cdrom0:\\RD\\FMG.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
	fmg_splash_tex2d = IMG_LoadPNG_RW(rwop);

	sprintf(filename, "cdrom0:\\RD\\GAOVUI.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
	gameover_tex2D = IMG_LoadPNG_RW(rwop);

	sprintf(filename, "cdrom0:\\RD\\WINUI.PNG");
	rwop = SDL_RWFromFile(filename, "rb");
...
int main(int argc, char *argv[]) {
	...
	//ttf stuff
	sprintf(filename, "cdrom0:\\RD\\VERMIN.TTF");
	rwop = SDL_RWFromFile(filename, "rb");
