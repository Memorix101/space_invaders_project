...
void load_assets()
{
	space3_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/space3.png");
	space3_tex = SDL_CreateTextureFromSurface(renderer, space3_surface);
	SDL_FreeSurface(space3_surface);

	enemy_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/invader32x32x4.png"); //invader32x32x4
	enemy_tex = SDL_CreateTextureFromSurface(renderer, enemy_surface);

	player_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/player.png");
	player_tex = SDL_CreateTextureFromSurface(renderer, player_surface);

	bullet_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/bullet.png");
	bullet_tex = SDL_CreateTextureFromSurface(renderer, bullet_surface);

	enemy_bullet_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/enemy-bullet.png");
	enemy_bullet_tex = SDL_CreateTextureFromSurface(renderer, enemy_bullet_surface);

	explo_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/explode.png");
	explo_tex = SDL_CreateTextureFromSurface(renderer, explo_surface);

	fmg_splash_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/fmg_splash.png");
	fmg_splash_tex = SDL_CreateTextureFromSurface(renderer, fmg_splash_surface);
	SDL_FreeSurface(fmg_splash_surface);

	gameover_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/gameover_ui.png");
	gameover_tex = SDL_CreateTextureFromSurface(renderer, gameover_surface);
	SDL_FreeSurface(gameover_surface);

	win_surface = IMG_Load("wiiu/apps/space-invaders-wiiu/rd/win_ui.png");
...
int main(int argc, char* argv[]) {
	...
	vermin_ttf = TTF_OpenFont("wiiu/apps/space-invaders-wiiu/rd/vermin_vibes_1989.ttf", 24);
	char textBuffer[64];
	...
	//load audio
	snd_blaster = Mix_LoadWAV("wiiu/apps/space-invaders-wiiu/rd/blaster.mp3");
	snd_explo = Mix_LoadWAV("wiiu/apps/space-invaders-wiiu/rd/explode1.wav");
	snd_pusher = Mix_LoadWAV("wiiu/apps/space-invaders-wiiu/rd/pusher.wav");
